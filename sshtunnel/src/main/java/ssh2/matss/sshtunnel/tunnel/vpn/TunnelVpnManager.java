...
public class TunnelVpnManager implements Tunnel.HostService
{
	...
	public void onDiagnosticMessage(String message)
	{
		...
		/*if (mSettings.mBundle.getBoolean(AppConstants.IS_LOCK)) {
		 ...
		 */
		VpnStatus.logInfo(message);
	}

	@Override
	public void onTunnelConnected()
	{
		VpnStatus.logInfo("<strong>Tunnel Conected</strong>");
	}
	...
	{
		VpnStatus.logInfo("<strong>VPN Established</strong>");
