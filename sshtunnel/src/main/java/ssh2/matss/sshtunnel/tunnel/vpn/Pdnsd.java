...
import ssh2.matss.sshtunnel.utils.FileUtils;
...
public class Pdnsd extends Thread {
	...
	public void run() {
		...
		try {
			...
			StreamGobbler.OnLineListener onLineListener = log -> VpnStatus.logDebug("Pdnsd: " + log);
			...
			VpnStatus.logException("Pdnsd Error", e);
		} catch(Exception e){
			VpnStatus.logDebug("Pdnsd Error: " + e);
		}
