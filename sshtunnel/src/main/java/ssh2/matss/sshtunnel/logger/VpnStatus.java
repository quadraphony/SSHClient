...
import ssh2.matss.sshtunnel.utils.LogFileHandler;
import ssh2.matss.sshtunnel.utils.TrafficHistory;
...
public class VpnStatus {
    ...
    public static boolean readFileLog =false;
    public final static Object readFileLock = new Object();
...
*/
    ...
    private static void logInformation() {
        ...
        */
    //  logInfo(R.string.built_by, "");
    //  logInfo(R.string.app_mobile_info, "", "");
        logInfo(R.string.mobile_info, Build.MODEL, Build.BOARD, Build.BRAND, Build.VERSION.SDK_INT,
                Build.VERSION.RELEASE, Build.ID, Build.FINGERPRINT, "", "");
 ...
 */
    ...
    public synchronized static void newLogItem(LogItem logItem, boolean cachedLine) {
        if (cachedLine) {
